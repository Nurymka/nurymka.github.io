...
export const HorizontalDivider = (props) => (
  <div {...props} className={`divider horizontal ${props.isMarginalized ? 'horizontal-margins' : ''}${props.className ? props.className : ''}`} />
)

export const VerticalDivider = (props) => (
  <div {...props} className={`divider vertical ${props.isMarginalized ? 'vertical-margins' : ''}${props.className ? props.className : ''}`}/>
)

HorizontalDivider.propTypes, VerticalDivider.propTypes = {
  isMarginalized: PropTypes.bool
}

export const LoadingLogo = () => (
  <svg width="111px" height="100vh" viewBox="0 0 111 1024" version="1.1" style={{position: 'fixed', display: 'block', top: 0, bottom: 0, left: 0, right: 0, margin: 'auto'}}>
      <g id="Welcome" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <g id="progressbar" fill="#FFFFFF">
              <g id="Group">
                  <g id="Group-2">
                      <polygon id="NK" points="62.0322581 1024.00001 62.0322581 483.586022 73.1612903 483.586022 73.1612903 510.763441 97.1935484 483.505376 109.451613 483.505376 87.516129 508.908602 110.822581 540.763441 98.3225806 540.763441 80.5 516.005376 73.1612903 523.666667 73.1612902 1024.00001"></polygon>
                      <polygon id="NK" points="11.6290323 504.069892 11.6290323 540.763441 0.5 540.763441 0.5 483.505376 9.12903226 483.505376 38.9677419 521.086022 41.064518 0 50.0967751 0 50.0967742 540.763441 41.0645161 540.763441"></polygon>
                  </g>
              </g>
          </g>
      </g>
...
export const AnimatedCloseIcon = React.createClass({
  getInitialState () {
    return {
      frameRate: 25,
      numberOfFrames: 16,
  ...
  componentDidMount() {
    this.setState({
      timer: setInterval(this.nextFrame, 1000 / this.state.frameRate)
    })
  },
  ...
  nextFrame() {
    if (this.state.currentFrame < this.state.numberOfFrames) {
  ...
  render () {
    return (
      <CloseIcon currentFrame={this.state.currentFrame}/>
    )
  }
})

const CloseIcon = ({ currentFrame }) => {
  const styleForG = (frame) => currentFrame === frame ? {display: 'inline-block'} : {display: 'none'}
  return (
    <svg title="Close menu" width='60px' height='60px' viewBox="0 0 20 20">
      <g style={styleForG(16)}>
...
export const PHOTO_SET = _.shuffle(GalleryPhotos.map(ph => ({
  src: ph.small.src,
  width: ph.small.width,
  height: ph.small.height,
  aspectRatio: ph.small.width / ph.small.height,
  lightboxImage: {
    src: ph.big.src
  }
})))
